...
const DESTINATARIOS = {
    ...
    modos: {
      jajas: {
        ...
        mensaje:
          ...
          'de nada, ya sé que no lo mereces 😌. Seguro estás sonriendo y frunciendo el ceño a la vez, ' +
          'y esa era justo la cara que quería ver. No me mires así 😤... te quiero igual, ' +
          'hasta cuando dices "ya estoy saliendo" y sigues en pijama. 😂💛',
        cancion: 'audio/todo-jajas.mp3',
        titulo: 'Canción de los jajas',     // ← cámbialo
        artista: 'Artista',                 // ← cámbialo
        portada: 'img/todo-jajas.jpg',      // ← tu imagen (cuadrada)
      },
      rial: {
        boton: 'el rial 💛',
        mensaje:
          'La primavera empieza hoy, pero yo ya florecí el día que te conocí. ' +
          'Cada flor amarilla de este universo es un motivo por el que me alegra que existas. ' +
          'Gracias por ser mi lugar favorito en todo el cosmos.',
        cancion: 'audio/todo-rial.mp3',
        titulo: 'Nuestra canción',          // ← cámbialo
        artista: 'Artista',                 // ← cámbialo
        portada: 'img/todo-rial.jpg',       // ← tu imagen (cuadrada)
      },
    },
  },
  mama: {
    nombre: 'Mamita Hermosa 💕',
    mensaje:
      'Mamá, gracias por sembrar en mí todo lo bonito que hoy florece. ' +
      'Eres mi sol, mi refugio y mi mejor casualidad. ' +
      'Hoy el universo entero se viste de amarillo para ti.',
    cancion: 'audio/mama.mp3',
    titulo: 'Para mamá',      // ← nombre de la canción
    artista: 'Artista',   // ← artista
    portada: 'img/mama.jpg',  // ← portada (cuadrada)
    color: 0xffb74d, // amarillo cálido
  },
  hermanita: {
    nombre: 'Hermanita Menor 👑',
    mensaje:
      'Hoy es tu día, enana: primavera, flores amarillas y juventud a full. ' +
      'Sigue brillando así de bacán, que el universo te queda chico. ' +
      'Y ya sabes: aquí tienes a alguien con nave propia para lo que sea. 🚀',
    cancion: 'audio/hermana.mp3',
    titulo: 'Para mi hermanita',      // ← nombre de la canción
    artista: 'Artista',   // ← artista
    portada: 'img/hermanita.jpg',  // ← portada (cuadrada)
  ...
  amiga: {
    ...
    mensaje:
      ...
      'Gracias por ser puro bacán: por las risas, los audios eternos y por quedarte siempre. ' +
      'Feliz primavera, que florezcas hasta en el espacio.',
    cancion: 'audio/amiga.mp3',
    titulo: 'Para mi amiga',      // ← nombre de la canción
    artista: 'Artista',   // ← artista
    portada: 'img/amiga.jpg',  // ← portada (cuadrada)
    color: 0xffdf4d, // amarillo limón
  },
  prima: {
    nombre: 'Prima Linda 🌻',
    mensaje:
      'Que esta primavera te llene de flores, buena vibra y planes bacanes. ' +
      'El universo entero te manda pétalos amarillos hoy. ' +
      '¡A florecer, prima!',
    cancion: 'audio/prima.mp3',
    titulo: 'Para mi prima',      // ← nombre de la canción
    artista: 'Artista',   // ← artista
    portada: 'img/prima.jpg',  // ← portada (cuadrada)
